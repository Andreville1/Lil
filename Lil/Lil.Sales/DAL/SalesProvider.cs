...
namespace Lil.Sales.DAL
{
    public class SalesProvider : ISalesProvider
    {
        ...
        public bool isCustomerId(string orderCustomerID)
        {
            bool isCustomerId = false;
            foreach (var order in repo)
            {
                if (order.CustomerId == orderCustomerID)
                {
                    isCustomerId = true;
                    break;
                }
        ...
        public bool isOrderItemQuantity(int orderItemQuantity)
        {
            ...
            foreach (var order in repo)
            {
                ...
                { 
                   if (orderItem.Quantity == orderItemQuantity)
                    {
                        isQuantity = true;
                        break;
                    } 
